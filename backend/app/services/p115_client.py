...
class P115Client:
    ...
    async def get_path_id(
        ...
        try:
            ...
            for idx, part in enumerate(parts):
                ...
                if str(current_id) != "0" and not self._is_temp_directory(intermediate_path):
                    await self._set_cached_path_id(library_name, intermediate_path, int(current_id))
    ...
    def _is_temp_directory(self, path: str) -> bool:
        ...
        is_temp = bool(re.match(r"^(?:[A-Z]{2,10}|[A-Z]\d{1,2})-\d{3,5}$", last_part))
